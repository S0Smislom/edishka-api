    ...
    "paths": {
        "/v1/diet": {
            "post": {
                ...
                "operationId": "create-diet",
                "parameters": [
                    {
                        "description": "diet info",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateDiet"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateDietItem"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.DietItem"
                        }
                    },
                    "default": {
                        "description": "",
        ...
        "/v1/diet-item/private": {
            "get": {
                ...
                "operationId": "get-diet-item-list",
                "parameters": [
                    {
                        "type": "integer",
                        "default": 25,
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.DietItemList"
                        }
                    },
                    "default": {
                        "description": "",
        ...
        "/v1/diet-item/{id}": {
            "delete": {
                ...
                "operationId": "delete-diet-item",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Diet item item id",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "operationId": "update-diet-item",
                "parameters": [
                    {
                        "description": "Diet item update data",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateDietItem"
                        }
                    },
                    {
                        "type": "integer",
                        "description": "Diet item id",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.DietList"
                        }
                    },
                    "default": {
                        "description": "",
        ...
        "/v1/diet/{id}": {
            ...
            "patch": {
                ...
                "summary": "Update diet",
                "operationId": "update-diet",
                "parameters": [
                    {
                        "description": "Diet update data",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateDiet"
                        }
                    },
                    {
                        "type": "integer",
        ...
        "/v1/recipe-product": {
            "get": {
                ...
                "operationId": "get-recipe-product-list",
                "parameters": [
                    {
                        "type": "integer",
                        "default": 25,
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.RecipeProductList"
                        }
                    },
                    "default": {
                        "description": "",
            ...
            "post": {
                ...
                "operationId": "create-recipe-product",
                "parameters": [
                    {
                        "description": "RecipeProduct info",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateRecipeProduct"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/recipe-product/{id}": {
            "get": {
                ...
                "operationId": "get-recipe-product",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "RecipeProduct id",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "delete": {
                ...
                "operationId": "delete-recipe-product",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "RecipeProduct id",
            ...
            "patch": {
                ...
                "operationId": "update-recipe-product",
                "parameters": [
                    {
                        "description": "RecipeProduct update data",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateRecipeProduct"
                        }
                    },
                    {
                        "type": "integer",
        ...
        "/v1/shopping-item": {
            ...
            "post": {
                ...
                "operationId": "create-shopping-item",
                "parameters": [
                    {
                        "description": "Shopping item info",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateShoppingItem"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/shopping-item/{id}": {
            "delete": {
                ...
                "operationId": "delete-shopping-item",
                "parameters": [
                    {
                        "type": "integer",
            ...
            "patch": {
                ...
                "operationId": "update-shopping-item",
                "parameters": [
                    {
                        "description": "Shopping item update data",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateShoppingItem"
                        }
                    },
                    {
                        "type": "integer",
        ...
        "model.Recipe": {
            ...
            "properties": {
                ...
                "products": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.RecipeProductMinimal"
                    }
                },
                "published": {
                    "type": "boolean"
